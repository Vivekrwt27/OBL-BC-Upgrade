report 50277 "kbs production alert"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\kbsproductionalert.rdl';

    dataset
    {
        dataitem(PremiumStock; Integer)
        {
            ...
            begin
                ...
                RecItem.SETFILTER(RecItem."Location Filter", LocCode);
                IF RecItem.FINDFIRST THEN BEGIN
                    REPEAT
                        RecItem.CALCFIELDS(RecItem."Reserved Qty. on Inventory");
                ...
                RecItem.SETRANGE(RecItem."Quality Code", '1');
                RecItem.SETFILTER(RecItem."Item Category Code", '<>%1', 'SAMPLE');
                ...
                IF RecItem.FINDFIRST THEN BEGIN
                    ...
                    REPEAT
                        ...
                        //Item2m:=COPYSTR(RecItem."No.",1,STRLEN(RecItem."No.")-2)+'2'+COPYSTR(RecItem."No.",STRLEN(RecItem."No."),STRLEN(RecItem."No."));
                        //Item3m:=COPYSTR(RecItem."No.",1,STRLEN(RecItem."No.")-2)+'3'+COPYSTR(RecItem."No.",STRLEN(RecItem."No."),STRLEN(RecItem."No."));
        ...
        dataitem("Item Amount3"; "Item Amount3")
        {
            ...
            begin
                ...
                CLEAR(FIRSTProdDate);
                ItemLedEntry.RESET;
                ItemLedEntry.SETCURRENTKEY(ItemLedEntry."Posting Date");
                ...
                IF PrintInActive = TRUE THEN BEGIN
                    ...
                    END ELSE
                        Day3 := (NRAmount / 1) * 30;
                    //16225  CurrReport.SHOWOUTPUT := TRUE
                END;
    ...
    begin
        ...
        END;
        RecILE.RESET;
        RecILE.SETCURRENTKEY(RecILE."Item No.", RecILE."Location Code", RecILE."Entry Type", RecILE."Posting Date");
        RecILE.SETRANGE(RecILE."Item No.", ItemCode);
        RecILE.SETFILTER(RecILE."Entry Type", '%1|%2', RecILE."Entry Type"::Sale, RecILE."Entry Type"::Transfer);
        RecILE.SETRANGE(RecILE."Posting Date", DateFrom, DateTo);
        RecILE.SETRANGE(RecILE."Location Code", LocCode);
        RecILE.SETFILTER(RecILE.Quantity, '<%1', 0);
        RecILE.SETRANGE(RecILE.Positive, FALSE);
