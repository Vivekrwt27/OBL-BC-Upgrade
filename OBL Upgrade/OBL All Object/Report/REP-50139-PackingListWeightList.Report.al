report 50139 "Packing List / Weight List"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayouts\PackingListWeightList.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; 112)
        {
            ...
            column(Customer_TINNo; '') // 16630 replace "T.I.N. No."
            {
            }
            column(GR_No; "GR No.")
            {
            ...
            column(SubTotal11; SubTotal + Taxtotal - InvDisc - InsDisc - ROUND("Sales Invoice Line".D1, 1, '=')) // 16630 replace "Excise Amount"
            {
            }
            column(A; 0.0)
            {
            }
            column(SubTotal111; ROUND((SubTotal + Taxtotal - InvDisc - InsDisc), 1, '=') - ROUND("Sales Invoice Line".D2, 1, '=')) // 16630 replace "Excise Amount"
            {
            }
            ...
            dataitem("Sales Invoice Line"; 113)
            {
                ...
                column(SaleInvoiceLineMRPPrice; "Sales Invoice Line"."MRP Price") // 16630 replace "MRP Price"
                {
                }
                column(Value; Value)
                {
                ...
                begin
                    ...
                    IF Quantity <> 0 THEN
                        BuyersPrice := Amount / Quantity; // 16630
            ...
            begin
                ...
                /* IF FormCodes.GET("Form Code") THEN BEGIN
                 ...
                 IF tin_no1.GET(Location."T.I.N. No.") THEN
                     "TINNo." := tin_no1.Description;*/ // 16630
                ...
                //LCDetailforExport.SETRANGE("LC No.","Sales Invoice Header"."LC Number");
