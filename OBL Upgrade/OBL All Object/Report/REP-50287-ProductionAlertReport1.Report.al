report 50287 "Production Alert Report1"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\ProductionAlertReport1.rdl';
            ...
            begin
                ...
                IF Retained = TRUE THEN BEGIN
                    ...
                    IF Item.GET("Item No.") THEN BEGIN
                        ...
                        DimValue.SETRANGE(DimValue.Code, Item."Type Catogery Code");
                        IF DimValue.FINDFIRST THEN BEGIN
                            DimValue1.SETRANGE(DimValue1."Dimension Code", 'GROUP CAT');
                            DimValue1.SETRANGE(DimValue1.Code, DimValue."Group Category");
                            IF DimValue1.FINDFIRST THEN;
                        END;
                    END;
