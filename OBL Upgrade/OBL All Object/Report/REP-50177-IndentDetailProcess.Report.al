report 50177 "Indent Detail Process"
{
    ProcessingOnly = true;
            ...
            dataitem("Indent Line"; 50017)
            {
                ...
                DataItemTableView = SORTING("Document No.", "Line No.")
                                    ...
                                    WHERE(Deleted = FILTER(false),
                                          Type = FILTER(Item),
                                          "Inventory Posting Group" = FILTER('<>PACK-IMP&<>PACK&<>INK-IMP&<>INK&<>GLAZE-IMP&<>GLAZE&<>FRIT&<>COL-IMP&<>COL&<>BODY-IMP&<>BODY')); //16767
                ...
                begin
                    ...
                    PurchRcptLineREC.SETCURRENTKEY("Indent No.", "Indent Line No.");
                    ...
                    IF "No." <> '' THEN BEGIN
                        ...
                        //ILE.SETRANGE(ILE."Posting Date",CALCDATE('-4M',"Indent Header".GETRANGEMIN("Indent Header"."Indent Date")) kulbhushan
                    ...
                    /* IncomeTaxAccountPeriod.SETFILTER("Starting Date", '<%1', TODAY);
                      IncomeTaxAccountPeriod.SETFILTER("Ending Date", '>%1', TODAY);
    ...
    trigger OnPreReport()
    begin
        "Indent Header".SETFILTER("Indent Header"."Indent Date", '%1..%2', 20010101D, TODAY);
    end;
    ...
    var
        ...
        // 16630  IncomeTaxAccountPeriod: Record 13724;
        StartDate: Date;
        EndDate: Date;
    ...
    local procedure CreateIndentHistoryLog()
    var
        IndentStatusHistory: Record "Indent Status History";
    begin
        IndentStatusHistory.RESET;
        IndentStatusHistory.SETRANGE("Reporting Date", TODAY);
        IndentStatusHistory.SETRANGE("Indent No.", "Indent Line"."Document No.");
        IndentStatusHistory.SETRANGE("Indent Line No.", "Indent Line"."Line No.");
        IF IndentStatusHistory.FINDFIRST THEN BEGIN
            IndentStatusHistory.DELETE;
            IndentStatusHistory.INIT;
            IndentStatusHistory."Reporting Date" := TODAY;
            IndentStatusHistory."Indent No." := "Indent Line"."Document No.";
            IndentStatusHistory."Indent Line No." := "Indent Line"."Line No.";
            IndentStatusHistory."Item Category Code" := "Indent Line"."Item Category Code";
            IndentStatusHistory."Item No." := "Indent Line"."No.";
            IndentStatusHistory.Status := IndentStatus;
            IndentStatusHistory.Plant := "Indent Line"."Location Code";
            IndentStatusHistory.Department := "Indent Header"."Department Code";
            IndentStatusHistory."Indent Status" := "Indent Header".Status;
            IndentStatusHistory.INSERT;
        END ELSE BEGIN
            IndentStatusHistory.INIT;
            IndentStatusHistory."Reporting Date" := TODAY;
            IndentStatusHistory."Indent No." := "Indent Line"."Document No.";
