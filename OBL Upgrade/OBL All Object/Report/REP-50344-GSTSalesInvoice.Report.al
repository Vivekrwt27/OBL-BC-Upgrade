report 50344 "GST Sales Invoice"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\GSTSalesInvoice.rdl';
...
DetailedGSTLedgerEntry.NEXT = 0;
                        ...
                        IF SalesInvoiceLine1.FIND('-') THEN BEGIN
                            ...
                            /*  TotalBed := TotalBed +
                              ...
                              TotalTradeDisc := TotalTradeDisc + SalesInvoiceLine1."Inv. Discount Amount";*///16225 Field N/F End
                        END;
                        ...
                        */
                        ...
                        /*  Discount := 0;
                          ...
                          END;
                          //msvc insurnace
                          // MESSAGE('%1', ROUND(InsurnaceCharge, 1, '='));
...
RecState.NEXT = 0;
                ...
                /* State1.RESET;
                 State1.SETRANGE(State1.Code, "Sales Invoice Line".State);
                 IF State1.FIND('-') THEN
                     Stname := State1.Description;*///16225 Table N/F End
