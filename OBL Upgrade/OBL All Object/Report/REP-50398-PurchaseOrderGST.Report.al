report 50398 "Purchase Order GST "
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\PurchaseOrderGST.rdl';
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(CurrencyCode_PurchaseHeader; "Purchase Header".Currency_Code)
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(TotalGSTAmount_PurchaseLine; TotlGSTAmount.TotalGSTAmtLine("Purchase Line"))
                        {
                        }
                        ...
                        column(Amount; TotlGSTAmount.AmttoVendorLine("Purchase Line"))
                        {
                        }
                        ...
                        column(GST_PurchaseLine; TotlGSTAmount.PurchaseLineGSTPer("Purchase Line"))
                        {
                        }
                        ...
                        column(TDSAmt; BalTDSIncludingSHECESS)
                        {
                        }
                        ...
                        //16225   column(PurchLineAmountToVendor; PurchLine."Amount To Vendor")
                        column(PurchLineAmountToVendor; TotlGSTAmount.AmttoVendorLine("Purchase Line"))
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(PurchLineTotalTDSIncludingSheCess; -TotalTDSIncludingSHECESS)
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        //16225 column(ServTaxeSBCAmt;PurchLine."Service Tax SBC Amount")
                        ...
                        dataitem(DimensionLoop2; Integer)
                        {
                            ...
                            begin
                                TDSEntry.Reset();
                                TDSEntry.SetRange("Document No.", "Purchase Line"."Document No.");
                        ...
                        begin
                            ...
                            /* IF "Purchase Line"."Tax %" <> 0 THEN
                               TaxPer := FORMAT("Purchase Line"."Tax %") + ' %';*///16225 field N/F End
                            ...
                            // TotalGstAmt := TotlGSTAmount.AmttoVendorLine("Purchase Line");//15578//PurchLine."Total GST Amount";    //RKS 060717
                            // TotalGstAmt := PurchLine."Amount";
                            GrandlGstAmt += TotlGSTAmount.TotalGSTAmtLine("Purchase Line");//15578
                                                                                           // GrandlGstAmt := 0;//16630
                            ...
                            /* StructureLineDetails.RESET;
                             ...
                             IF "Excise%" = '' THEN
                               ...
                               ELSE
                                 "Excise%" := '';*/ //16225 Table N/F End

                            //16225 TotalGSTAmount += PurchLine."Total GST Amount"; //GST
                            TotalGSTAmount += PurchLine."Amount";
                            /*
                            //RKS
                        ...
                        begin
                            ...
                            /* CurrReport.CREATETOTALS(PurchLine."Line Amount",PurchLine."Inv. Discount Amount",
                             ...
                             CurrReport.CREATETOTALS(PurchLine."Service Tax SHE Cess Amount");*///16225 Field N/F End
                            CLEAR(TotLM);
                            CLEAR(TotalDisAmt);
                        end;
                    }
                    ...
                    dataitem(RowsIns; Integer)
                    {
                        ...
                        column(AmountInWord; uppercase(descri[1] + descri[2]))
                        {
                        }
            ...
            begin
                ...
                /*  PurLine.RESET;
                  ...
                  IF PurLine.FINDFIRST THEN
                    ...
                    UNTIL
                    PurLine.NEXT = 0;*///16225 Table N/F End
                IF CountTemp <> 0 THEN
                    IF TempCount > 1 THEN
    ...
    var
        ...
        BalTDSIncludingSHECESS: decimal;
        TotalTDSIncludingSHECESS: decimal;
        ...
        cdcurr: Code[5];
        TotlGSTAmount: Codeunit CalcAmttoVendor;
