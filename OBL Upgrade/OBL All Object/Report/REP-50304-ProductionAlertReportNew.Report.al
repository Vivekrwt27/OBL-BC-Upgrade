report 50304 "Production Alert Report New"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\ProductionAlertReportNew.rdl';
    ...
    dataset
    {
        dataitem(PremiumStock; Integer)
        {
            ...
            begin
                ...
                RecItem.SETFILTER("Item Category Code", '<>%1', 'SAMPLE');
        ...
        dataitem("Item Amount3"; "Item Amount3")
        {
            ...
            column(TypeCatCode; DimValue1.Code)
            {
            }
            column(DimValue_Name; DimValue1.Name)
            {
            }
            ...
            begin
                ...
                IF Retained = TRUE THEN BEGIN
                    ...
                    IF Item.GET("Item No.") THEN BEGIN
                        ...
                        IF DimValue.FINDFIRST THEN BEGIN
                            DimValue1.SETRANGE("Dimension Code", 'GROUP CAT');
                            DimValue1.SETRANGE(Code, DimValue."Group Category");
                ...
                IF PrintInActive = TRUE THEN BEGIN
                    ...
                    END ELSE
                        Day3 := (NRAmount / 1) * 30;
                    //166225 CurrReport.SHOWOUTPUT := TRUE 
                END;

                //  "Item Amount3"."Amount 2"
                //IF "Item Amount3".Amount =0 THEN
                //CurrReport.SKIP;
