report 50062 "Inventory Ageing Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayouts\InventoryAgeingReport.rdl';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING(SuggestedResponse, "TaxPeriod-GSTR 3B") ORDER(Ascending) WHERE(SuggestedResponse = FILTER('*2021|*2022'));
            ...
            begin
                IF (OptMonth = OptMonth::" ") AND (OptYear = OptYear::" ") THEN
                    IF EVALUATE(YearInt, COPYSTR("EYAIM_ERP 108DFs Report".SuggestedResponse, STRLEN("EYAIM_ERP 108DFs Report".SuggestedResponse) - 3, 4)) THEN BEGIN
                        // ERROR(COPYSTR("Inventory Report Ageing Data".Month,STRLEN("Inventory Report Ageing Data".Month)-3,4));
                        /*  IF YearInt = 2021 THEN
                              IF "EYAIM_ERP 108DFs Report".VendorRiskCategory < 6 THEN CurrReport.SKIP;*/
                    END;
                ...
                /* IF "EYAIM_ERP 108DFs Report"."TaxableValue(2A)" > 0 THEN
                 ...
                 END ELSE
                     ExpMonthlySales := "EYAIM_ERP 108DFs Report"."BillOfEntry(PR)";*/
