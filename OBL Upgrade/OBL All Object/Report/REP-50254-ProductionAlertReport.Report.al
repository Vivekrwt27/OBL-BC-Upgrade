report 50254 "Production Alert Report"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\ProductionAlertReport.rdl';
    ...
    dataset
    {
        dataitem(PremiumStock; Integer)
        {
            ...
            begin
                ...
                RecItem.SETFILTER(RecItem."Item Category Code", '<>%1&<>%2', 'SAMPLE', 'T001');
    ...
    begin
        //ERROR('Report Cannot be Excecutable');
        PrintInActive := TRUE;
    end;
