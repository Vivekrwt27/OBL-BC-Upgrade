...
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayouts\PerformaInvoiceExport.rdl';
        ...
        dataitem("Sales Header"; 36)
        {
            ...
            dataitem(CopyLoop; 2000000026)
            {
                ...
                dataitem("Sales Line"; "Sales Line")
                {
                    ...
                    column(LineDisAmt; "Sales Header"."Discount Amount")
                    {
                    }
...
RecState.NEXT = 0;
    ...
    */
    ...
    var
        ...
        ArnSKD: Label 'AD0903220365737 Date. 31.03.2022';
        ArnDoraMorbi: Label 'AD240322038871B  Date. 31.03.2022';
        ARNNoDt: Text[200];
