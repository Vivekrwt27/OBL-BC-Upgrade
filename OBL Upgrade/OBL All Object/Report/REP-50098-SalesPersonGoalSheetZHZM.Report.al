report 50098 "Sales Person Goal Sheet ZH/ZM"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\ReportLayouts\SalesPersonGoalSheetZHZM.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;

    dataset
    {
        dataitem("Sales Person Goal Details"; 50091)
        {
            ...
            column(PointonIncCashFlow; "Sales Person Goal Details"."Pts. on Increase Cash FLow")
            {
            }
            column(PercAchiveIncreaseCashFlow; PercAchiveIncreaseCashFlow)
            {
            }
            ...
            begin
                ...
                SPPCHGoalSheetCalculation.GetMonthlyRevenue("Sales Person Goal Details"."FF Type", "Sales Person Goal Details"."Field Force Code",
                              20200104D, 20210331D, LYYTDSales, NotReq, NotReq, NotReq, NotReq, NotReq, NotReq, NotReq, NotReq, FALSE);
                ...
                PercAchiveIncreaseCashFlow := FieldForceGoalMgt.CalculatePercentage("Sales Person Goal Details"."Outstanding 75 DAys", "Sales Person Goal Details"."90 Days Sale");
                ...
                */
                ...
                SalesPersonGoalDetails.SETFILTER("For Month", '%1..%2', 20220104D, AsOnDate);
    ...
    var
        ...
        PercAchiveIncreaseCashFlow: Decimal;
