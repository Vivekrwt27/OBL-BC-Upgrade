report 50314 "Transfer Order SKD"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\TransferOrderSKD.rdl';
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            column(LocCST; RecLoc."T.C.A.N. No.")
            {
            }
            ...
            /* dataitem(DataItem1000000040; 13798)//16225 Table N/F
             {
