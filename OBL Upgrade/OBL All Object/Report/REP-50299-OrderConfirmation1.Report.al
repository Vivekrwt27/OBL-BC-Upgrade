report 50299 "Order Confirmation1"
{
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = '.\ReportLayouts\OrderConfirmation1.rdl';
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        begin
                            ...
                            AmttoCust += TotalAmt + cgst + sgst + igst;
                            ...
                            begin
                                ...
                                IF ShowInternalInfo THEN BEGIN
                                    ...
                                    /*    NNC_SalesLineExciseAmt += SalesLine."Excise Amount";
                                        ...
                                        NNC_SalesLineKKCessAmt += SalesLine."KK Cess Amount";*///16225 Field N/F End
...
DetailedGSTEntryBuffer.NEXT = 0;
                              ...
                              IF StructureLineDetails.FIND('-') THEN
                                  REPEAT
                                      ...
                                      IF StructureLineDetails."Tax/Charge Type" = StructureLineDetails."Tax/Charge Type"::Excise THEN
                                          ExciseAmount := ExciseAmount + StructureLineDetails.Amount;*///16225 Table N/F End
                                                                                                       //sash block
                     ...
                     TotalAmount := SalesLine."Line Amount" - VATAmountLine."Invoice Discount Amount" + SalesLine."Excise Amount" + SalesLine."Tax Amount"
                       ...
                       SalesLine."KK Cess Amount";*///16225 Table N/F End
                        ...
                        begin
                            ...
                            /*  CurrReport.CREATETOTALS(SalesLine."Line Amount", SalesLine."Inv. Discount Amount", SalesLine."Excise Amount", SalesLine."Tax Amount",
                              ...
                              CurrReport.CREATETOTALS(SalesLine."KK Cess Amount");*///16225 Field N/F End
