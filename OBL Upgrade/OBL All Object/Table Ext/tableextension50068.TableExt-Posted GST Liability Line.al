tableextension 50068 tableextension50068 extends "Posted GST Liability Line"
{
    fields
    {
        modify("Document No.")
        ...
        modify("Parent Item No.")
        {
            ...
            //Unsupported feature: Property Modification (Name) on ""Parent Item No."(Field 6)".
        ...
        modify("Unit of Measure Code")// 15578 "Unit of Measure"
        {
