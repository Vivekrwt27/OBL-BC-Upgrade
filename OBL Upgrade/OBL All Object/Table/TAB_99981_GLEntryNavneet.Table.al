table 99981 "G/L Entry Navneet"
{
    Caption = 'G/L Entry';
    //DrillDownPageID = 90001;//16225 PAGE N/F
    //LookupPageID = 90001;//16225 PAGE N/F
    ...
    fields
    {
        ...
        field(27; "User ID"; Code[20])
        {
            ...
            begin
                //LoginMgt.LookupUserID("User ID"); //16225 LookupUserID N/F CODEUNIT
            end;
        }
