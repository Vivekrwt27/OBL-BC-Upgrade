table 99986 "G/L Entry New 080307"
{
    Caption = 'G/L Entry';
    ...
    fields
    {
        ...
        field(27; "User ID"; Code[20])
        {
            ...
            begin
                //LoginMgt.LookupUserID("User ID"); //16225 LookupUserID CODEUNIT
            end;
        }
        ...
        field(49; "Gen. Bus. Posting Group"; Code[10])
        {
            ...
            /* TableRelation = IF ("Gen. Posting Type"=FILTER(<>Payroll)) "Gen. Business Posting Group"
                             ELSE IF ("Gen. Posting Type"=FILTER(Payroll)) 33000072;*/
        }
        field(50; "Gen. Prod. Posting Group"; Code[10])
        {
            ...
            /* TableRelation = IF ("Gen. Posting Type"=FILTER(<>Payroll)) "Gen. Product Posting Group"
                             ELSE IF ("Gen. Posting Type"=FILTER(Payroll)) 33000073;*/
        }
    ...
    keys
    {
        ...
        key(Key16; "G/L Account No.", "Inventory Posting Group", "Posting Date", "Source Code")
        {
            SumIndexFields = Amount, "Debit Amount", "Credit Amount", "Additional-Currency Amount", "Add.-Currency Debit Amount", "Add.-Currency Credit Amount";
        }
        key(Key17; "Value Entry No.", "Inventory Posting Group")
        {
        }
    }
