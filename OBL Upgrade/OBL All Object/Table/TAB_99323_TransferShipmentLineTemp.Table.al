table 99323 "Transfer Shipment Line Temp"
{
    ...
    fields
    {
        ...
        field(13730; "Capital Item"; Boolean)
        {
            ...
            Description = 'For Deferred Excise for Item & Entry to RG23C';
        }
        ...
        field(13780; "Claim Deferred Excise"; Boolean)
        {
            ...
            Description = 'For Claiming Excise Deferred Amount';
        }
    ...
    keys
    {
        ...
        key(Key3; "Size Code", "Unit of Measure Code")
        {
        }
        key(Key4; "Type Code", "Transfer-to State", "Transfer-to Code")
        {
        }
        key(Key5; "Size Code", "Plant Code")
        {
        }
        key(Key6; "Size Code", "Packing Code", "Unit of Measure Code")
        {
        }
        key(Key7; "Plant Code", "Type Code", "Item No.", "Posting Date", "Unit of Measure Code")
        {
        }
        key(Key8; "Item No.", "Posting Date", "Unit of Measure Code")
        {
        }
        key(Key9; "Type Catogery Code")
        {
        }
    }
