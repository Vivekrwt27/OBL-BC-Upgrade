table 99301 "Purchase Line Temp"
{
    ...
    fields
    {
        ...
        field(6; "No."; Code[20])
        {
            ...
            ELSE
            IF (Type = CONST(Item)) Item WHERE("Plant Code" = FILTER(0 .. 9 | ''))
            ELSE
        ...
        {
            CalcFormula = Sum("Reservation Entry".Quantity WHERE("Source Type" = CONST(39),
        ...
        field(50017; "Assessable Value"; Decimal)
        {
        }
        field(50018; "VAT Type"; Option)
        {
    ...
    keys
    {
        key(Key1; "Document Type", "Document No.", "Line No.")
        {
            ...
            SumIndexFields = Amount, "Amount Including VAT", "Amount Including Tax", "Import Quantity Value", "Allocated Incentive Amount", "Amount Including Duties", "Line Amount";
        }
        key(Key2; "Document Type", Type, "No.", "Variant Code", "Drop Shipment", "Location Code", "Expected Receipt Date")
        {
            SumIndexFields = "Outstanding Qty. (Base)";
        }
        key(Key3; "Document Type", "Pay-to Vendor No.", "Currency Code")
        {
            MaintainSIFTIndex = false;
        ...
        key(Key9; "Item Type", "Document Type", "Document No.")
        {
            SumIndexFields = Amount, "Allocated Incentive Amount";
        }
        key(Key10; "Buy-from Vendor No.", "Order Date", Type, "No.")
        {
        }
        key(Key11; "Buy-from Vendor No.", "Document No.", "Order Date", Type, "No.")
        {
        }
        key(Key12; "Buy-from Vendor No.", "Product Group Code", "Document No.", "Order Date", Type, "No.")
        {
        }
    }
