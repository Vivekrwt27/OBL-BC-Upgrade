table 99308 "Sales Line Temp"
{
    ...
    fields
    {
        ...
        field(13736; "Concessional Code"; Code[10])
        {
            ...
            // TableRelation = "Concessional Codes";//16225
        }
        ...
        field(13796; "Form Code"; Code[10])
        {
            ...
            //StateForms: Page 13702;//16225 PAGE N/F
            begin
            end;
        }
        ...
        field(50037; "Quantity in Blanket Order"; Decimal)
        {
            CalcFormula = Sum("Sales Line"."Outstanding Quantity" WHERE("Document Type" = FILTER("Blanket Order"),
                                                                         ...
                                                                         "Location Code" = FIELD("Location Code"),
                                                                         "Variant Code" = FIELD("Variant Code")));
            //"Status"=FILTER("Released")));//16225 N/F sale Line Table
            Editable = false;
            FieldClass = FlowField;
        }
    ...
    keys
    {
        key(Key1; "Document Type", "Document No.", "Line No.")
        {
            ...
            SumIndexFields = Amount, "Amount Including VAT", "Outstanding Amount", "Shipped Not Invoiced", "Outstanding Amount (LCY)", "Shipped Not Invoiced (LCY)", "Amount Including Tax", "Quantity in Sq. Mt.", "Net Weight", "Gross Weight", Quantity, "Qty. to Ship", "Amount To Customer";
        }
        ...
        {
            MaintainSIFTIndex = false;
            SumIndexFields = "Outstanding Amount", "Shipped Not Invoiced", "Outstanding Amount (LCY)", "Shipped Not Invoiced (LCY)", "Return Rcd. Not Invd. (LCY)", Amount, "Amount To Customer";
        }
        ...
        key(Key10; "Size Code", "Quality Code")
        {
        }
        key(Key11; "Design Code", "Color Code", "Quality Code", "Size Code", "Packing Code")
        {
        }
        key(Key12; "Design Code", "Color Code", "Quality Code", "Size Code", "Packing Code", "Sell-to Customer No.")
        {
        }
        key(Key13; "Sell-to Customer No.", "Document No.")
        {
        }
        key(Key14; "Blanket Order Line No.", "Blanket Order No.", "Document Type")
        {
            SumIndexFields = "Outstanding Qty. (Base)";
        }
        key(Key15; "Document Type", Type, "No.", "Variant Code", "Location Code", Status)
        {
            SumIndexFields = Quantity, "Outstanding Quantity";
        }
    }
