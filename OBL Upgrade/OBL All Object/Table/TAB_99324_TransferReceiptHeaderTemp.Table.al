table 99324 "Transfer Receipt Header Temp"
{
    ...
    fields
    {
        ...
        {
            //  TableRelation = "Tax Forms Details" WHERE ("Form Code"=FIELD("Form Code")); //16225 TABLE N/F
        }
    ...
    keys
    {
        ...
        key(Key5; "Transfer Order No.", "Posting Date")
        {
        }
    }
