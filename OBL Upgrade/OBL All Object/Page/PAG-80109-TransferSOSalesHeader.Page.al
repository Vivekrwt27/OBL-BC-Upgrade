page 80109 "Transfer SO Sales Header"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    Permissions = tabledata 50100 = rim;
    SourceTable = 50100;
    ...
    layout
    {
        area(Content)
        {
            repeater(GroupName)
            {
                ...
                field("Specified Ent Team"; Rec."Specified Ent Team")
                {
                    ApplicationArea = All;

                }
                field("Govt Ent Team"; Rec."Govt Ent Team")
                {
                    ApplicationArea = All;
                ...
                field("Placed By BH"; Rec."Placed By BH")
                {
                    ApplicationArea = All;
                ...
                field("Private Ent Team"; Rec."Private Ent Team")
                {
                    ApplicationArea = All;
                ...
                field("Vehicle Provided"; Rec."Vehicle Provided")
                {
                    ApplicationArea = All;

                }
                field("Collection Within"; Rec."Collection Within")
                {
                    ApplicationArea = All;
                ...
                field("Vehicle Desc"; Rec."Vehicle Desc")
                {
                    ApplicationArea = All;
